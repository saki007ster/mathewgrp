...
const Locations = () => {
  return (
    <>
      <Breadcrumb
        pageName="Locations"
        description="Our locations are designed to make you feel at home."
      />
      ...
      <section className="pb-[80px] pt-[80px]">
        ...
        <SectionTitle
          ...
          paragraph="Visit our Locations page for interactive maps, operating hours, and direct contact information for each restaurant."
          mb="44px"
        />
